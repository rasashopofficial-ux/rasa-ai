...
export default function RasaAI() {
  // Inject API key from meta tag
  if (typeof window !== "undefined" && !window.__RASA_KEY__) {
    var meta = document.querySelector("meta[name=rk]");
    if (meta) window.__RASA_KEY__ = atob(meta.content);
  }
