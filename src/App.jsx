...
const VIDEO_MODELS = [
  { id: "sora2_free", name: "Sora 2", color: "#22D3EE", free: true,  plan: "free",    badge: "FREE", cost: 0 },
  { id: "veo3",       name: "Veo 3",  color: "#D946EF", free: false, plan: "starter", badge: "HD",   cost: 2 },
  { id: "runway",     name: "Runway", color: "#F59E0B", free: false, plan: "creator", badge: "PRO",  cost: 3 },
...
async function callAI(prompt) {
  const res = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    headers: {
      ...
      "anthropic-version": "2023-06-01","x-api-key": "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",
